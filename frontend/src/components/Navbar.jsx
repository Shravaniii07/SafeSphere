      ...
      <div className="flex items-center gap-2">
        <div className="hidden md:flex items-center gap-2 px-4 py-2 bg-slate-50/80 border border-slate-100 rounded-xl min-w-[220px] group focus-within:bg-white focus-within:border-secondary focus-within:shadow-[0_0_0_3px_rgba(6,182,212,0.08)] transition-all duration-200">
          ...
          <input
            ...
            className="border-none bg-transparent text-sm w-full text-slate-800 placeholder-slate-400 outline-none"
          />
        ...
        <button onClick={() => navigate('/notifications')} className="relative w-10 h-10 rounded-xl flex items-center justify-center text-slate-500 hover:bg-slate-100 hover:text-slate-800 transition-all duration-200 cursor-pointer min-h-[44px] min-w-[44px]" aria-label="Notifications">
        ...
        <button onClick={() => navigate('/profile')} className="w-9 h-9 rounded-full bg-gradient-to-br from-primary to-primary-light text-white flex items-center justify-center font-display font-semibold text-sm hover:shadow-[0_0_0_3px_rgba(15,23,42,0.15)] active:scale-95 transition-all duration-200 cursor-pointer min-h-[44px] min-w-[44px]" aria-label="Profile">
          {user.initials}
        </button>
      </div>
    </header>
