...
export default function AdminLogin() {
  ...
  const inputClass = (hasError) => `w-full pl-10 pr-4 py-3 border rounded-xl bg-white/[0.04] text-white text-sm transition-all duration-200 hover:border-white/20 focus:border-[#E63946] focus:ring-2 focus:ring-[#E63946]/20 focus:outline-none placeholder-white/20 ${hasError ? 'border-[#E63946] ring-1 ring-[#E63946]/20' : 'border-white/10'}`
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden" style={{ background: 'linear-gradient(135deg, #0A0F1E 0%, #1D3557 50%, #0A0F1E 100%)' }}>
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-40 -right-40 w-[500px] h-[500px] bg-[#E63946]/6 rounded-full blur-3xl animate-float" />
        <div className="absolute -bottom-40 -left-40 w-[400px] h-[400px] bg-[#457B9D]/6 rounded-full blur-3xl animate-float-delayed" />
      ...
      <div className="relative z-10 w-full max-w-[440px]">
        ...
        <div className="text-center mb-8 animate-page-in">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-[#E63946]/20 to-[#457B9D]/20 border border-white/10 mb-5 shadow-glow-red">
          ...
          <div className="flex items-center justify-center gap-2 mb-2">
            ...
            <span className="px-2 py-0.5 text-[10px] font-heading font-bold uppercase tracking-wider text-[#E63946] bg-[#E63946]/10 rounded-full border border-[#E63946]/20">Restricted</span>
          </div>
          <p className="text-white/40 text-sm">Authorized personnel only</p>
        </div>

        {/* Login Card */}
        <div className="bg-white/[0.04] backdrop-blur-xl rounded-2xl border border-white/10 p-8 animate-scale-pop shadow-elevated">
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            {/* Email */}
            <div className="space-y-2">
              <label className="text-[13px] font-semibold text-white/60 font-heading tracking-wide">Admin Email</label>
            ...
            {/* Password */}
            <div className="space-y-2">
              <label className="text-[13px] font-semibold text-white/60 font-heading tracking-wide">Password</label>
              <div className="relative">
                <Lock className="absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 text-white/30 pointer-events-none" />
                <input type={showPassword ? 'text' : 'password'} placeholder="••••••••" {...register('password')}
                  className={`w-full pl-10 pr-12 py-3 border rounded-xl bg-white/[0.04] text-white text-sm transition-all duration-200 hover:border-white/20 focus:border-[#E63946] focus:ring-2 focus:ring-[#E63946]/20 focus:outline-none placeholder-white/20 ${errors.password ? 'border-[#E63946] ring-1 ring-[#E63946]/20' : 'border-white/10'}`} />
                <button type="button" onClick={() => setShowPassword(!showPassword)} className="absolute right-3.5 top-1/2 -translate-y-1/2 text-white/30 hover:text-white/60 transition-colors cursor-pointer">
            ...
            {/* Secret Key */}
            <div className="space-y-2">
              <label className="text-[13px] font-semibold text-white/60 font-heading tracking-wide flex items-center gap-2">
